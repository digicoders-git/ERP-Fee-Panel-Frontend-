...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { path: '/fee-configuration', icon: FaCreditCard, label: 'Fee Configuration' },
    { path: '/hostel-library', icon: FaBuilding, label: 'Hostel & Library' },
    { path: '/payment-options', icon: FaCreditCard, label: 'Payment Options' },
    { path: '/scholarship-discount', icon: FaGift, label: 'Scholarships' },
    { path: '/pending-alerts', icon: FaBell, label: 'Pending Alerts' },
