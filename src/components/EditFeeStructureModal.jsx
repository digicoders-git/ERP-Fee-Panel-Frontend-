...
const EditFeeStructureModal = ({ isOpen, onClose, onEdit, feeStructure, classes = [] }) => {
  ...
  useEffect(() => {
    if (feeStructure) {
      setFormData({
        ...
        hostelFee: feeStructure.hostelFee?.toString() || ''
      });
    }
  }, [feeStructure]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 appearance-none bg-white opacity-70 cursor-not-allowed"
              required
              disabled
            >
            ...
            <p className="text-[10px] text-gray-500 mt-1 ml-1">* Class cannot be changed after creation</p>
          </div>
