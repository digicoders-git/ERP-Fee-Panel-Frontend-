...
import HostelLibraryPage from './pages/HostelLibraryPage';
            ...
            <div className="App">
              <Routes>
                ...
                <Route path="/" element={
                  ...
                  <Route path="hostel-library" element={<HostelLibraryPage />} />
                  <Route path="payment-options" element={<PaymentOptionsPage />} />
                  <Route path="scholarship-discount" element={<ScholarshipDiscountPage />} />
                  <Route path="pending-alerts" element={<PendingAlertsPage />} />
